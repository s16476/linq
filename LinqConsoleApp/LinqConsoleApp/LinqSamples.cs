    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            ...
            var res = Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000)
        ...
        public void Przyklad3()
        {
            ...
            Console.WriteLine("SELECT MAX(Salary) FROM Emps; - " + max);
            finish();
        }
        ...
        {
            Console.WriteLine("\"true\" jeśli choć jeden z elementów kolekcji pracuje jako \"Backend programmer\"");
        ...
        {
            Console.WriteLine(" pomocą języka LINQ i metody SelectMany wykonaj złączenie typu CROSS JOIN");
            ...
            {
                Console.WriteLine(r.emp.Ename + " " + r.dept.Dname);
            }
            finish();
        }

        private void writeResultEmp(IEnumerable<Emp> res)
        {
